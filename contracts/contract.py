...
class ScopeLock(gl.Contract):
    ...
    def _assess(self, project, description, reason):
        prompt = (
            ...
            "4. CHANGE_ORDER only when the work is related and not explicitly excluded, but materially "
            "expands obligations, cost, time, risk, quality level, integrations, or acceptance conditions.\n"
            "5. OUT_OF_SCOPE is mandatory when the work appears in EXCLUSIONS, or is unrelated, forbidden, "
            "contradictory, or impossible under the agreement. Explicit exclusions take precedence over "
            "the fact that a request may otherwise be related to the project.\n"
